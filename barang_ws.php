...
etc(); encryption(); session(); connect(); head(); body(); timing(); pagination();
?>
...
function confirmDeletion(no) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                window.location.href = `component/delete/delete_master?no=${no}&forward=<?php echo $forward; ?>&forwardpage=barang_ws&chmod=<?php echo $chmod; ?>`;
...
<div class="box">
    ...
    <div class="box-body">
        ...
        <p>
            ...
            <button id="export-excel" class="btn btn-success btn-sm" onclick="window.location.href='export_excel_ws.php'"><i class="fa fa-file-excel-o"></i> Export Excel</button>
        ...
        <p>
            ...
            <a href="barang_ws?q=stokmin" class="btn bg-orange btn-sm"><i class="fa fa-check"></i> Stok Minimal</a>
        ...
        // Query selalu filter SKU yang dimulai dengan 'WS-'
