...
<?php }?>
      ...
      <input type="hidden" class="form-control" id="insert" name="insert" value="<?php echo $insert;?>" maxlength="1" >
              ...
              <div class="box-footer" >
                <a href="admin" class="btn btn-flat bg-orange">Batal</a>
                <button type="submit" class="btn bg-blue btn-flat" name="simpan" onclick="document.getElementById('Myform').submit();" ><span class="glyphicon glyphicon-floppy-disk"></span> Simpan</button>
              </div>
              <!-- /.box-footer -->
 </form>
</div>
    ...
    <div class="row">
      <div class="col-sm-6 border-right">
        <div class="description-block">
          ...
          <span class="description-text"><?php echo $jabatan; ?> </span>
        </div>
      </div>
      <div class="col-sm-6 ">
        <div class="description-block">
          <h5 class="description-header">Umur</h5>
          <span class="description-text"><?php echo $umur; ?></span>
        </div>
      </div>
    </div>
  </div>
...
<?php if($no == null || $no == ""){}else{ ?>
   ...
   <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">EDIT PASSWORD</h3>
                ...
                <input type="hidden" id="username" name="username" value="<?php echo $username; ?>" readonly>
                                     ...
                                     <div class="row">
              <div class="form-group col-md-12 col-xs-12" >
                <label for="nohp" class="col-sm-3 control-label">Password:</label>
                <div class="col-sm-9">
       ...
       <div class="row">
              <div class="form-group col-md-12 col-xs-12" >
                <label for="nohp" class="col-sm-3 control-label">Ulangi Password:</label>
                <div class="col-sm-9">
       ...
       <div class="box-footer" >
                ...
                <button type="submit" class="btn btn-danger btn-flat" name="edit" ><span class="glyphicon glyphicon-floppy-disk"></span> SIMPAN PASSWORD</button>
              </div>
...
if ($password==$password2){
                       ...
                       $password = md5($_POST["password"]);
                      $ipassword = sha1($password);
                  
                      
                      $sql2="UPDATE $tabeldatabase set pa_ssword='$ipassword' WHERE userna_me='$una'";
                      $qry=mysqli_query($conn,$sql2);
                      if($sql){
                         echo "<script type='text/javascript'>  alert('Berhasil, Password telah diubah!');</script>";
