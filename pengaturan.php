        ...
        $namae= $_POST["namae"];
              ...
              if(mysqli_num_rows($result)>0){
                $sql1 = "update data set namae='$namae', alamate='$alamate', notelpe='$notelpe', ketentuane='$ketentuane' where no='1'";
                  ...
                  <?php echo "<script type='text/javascript'>window.location = 'pengaturan.php?update=success';</script>"; ?><?php
                } else { ?>
                  <?php echo "<script type='text/javascript'>window.location = 'pengaturan.php?update=fail';</script>"; ?><?php
	}
			  }
				  }
  }
