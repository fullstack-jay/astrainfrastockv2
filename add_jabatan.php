              ...
              <div class="box-body">
                ...
                <div class="row">
                        <div class="form-group col-md-6 col-xs-12" >
                          ...
                          <div class="col-sm-9">
                           <?php  if($no == null || $no ==""){ ?>
                            <input type="text" class="form-control" id="kode" name="kode" value="<?php echo autoNumber(); ?>" maxlength="20" required readonly>
                          <?php }else{ ?>
...
?>
               ...
               <td>
                <?php if($fill['nama']=='admin' || $fill['nama']=='kassa'){} else {?>
