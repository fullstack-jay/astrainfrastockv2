...
if ($_SESSION['jabatan'] == 'admin') {
  ?>
    ...
    $hasil2 = mysqli_query($conn,"SELECT * FROM chmenu WHERE userjabatan LIKE '$q'");
...
?>
   ...
   <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="userjabatan" value="<?php echo $q; ?>" readonly>
                  </div>
                </div>

             
             <input type="hidden" class="form-control" id="menu1" name="menu1" placeholder="Masukkan Hak Akses" value="<?php echo $menu1; ?>" maxlength="1">
                

         <div class="form-group">
                  <label for="menu2" class="col-sm-3 control-label">Menu Supplier/Customer</label>
                  <div class="col-sm-9">
        ...
        <div class="form-group">
                  <label for="menu8" class="col-sm-3 control-label">Menu Stok Persediaan</label>
                  <div class="col-sm-9">
              ...
              <div class="box-footer">
                  <a href="add_jabatan" class="btn btn-flat bg-orange"> Kembali</a>
        ...
        if(isset($_POST['simpan'])){
           ...
           $sql1 = "update chmenu set menu1='$menu1', menu2='$menu2', menu3='$menu3', menu4='$menu4', menu5='$menu5', menu6='$menu6', menu7='$menu7', menu8='$menu8',menu9='$menu9',menu10='$menu10',menu11='$menu11' where userjabatan = '$userjabatan'";
             $result = mysqli_query($conn, $sql1);
               echo "<script type='text/javascript'>  alert('Berhasil, Hak akses sudah diupdate!'); </script>";
              echo "<script type='text/javascript'>window.location = 'set_chmod?q=$userjabatan';</script>"; 
        }else{
                $sql1 = "insert into chmenu values('$userjabatan','$menu1','$menu2','$menu3','$menu4','$menu5','$menu6','$menu7','$menu8','$menu9','$menu10','$menu11')";
              $result = mysqli_query($conn, $sql1);
                 echo "<script type='text/javascript'>  alert('Berhasil, Hak Akses sudah ditambahkan!'); </script>";
