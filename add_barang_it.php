...
function autoNumber(){
  ...
  global $forward;
  $query = "SELECT MAX(RIGHT(kode, 3)) as max_id FROM $forward ORDER BY kode";
...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
  ...
  <!-- KONTEN BODY AWAL -->
    ...
    $kode=$nama=$asetmasuk=$sisa=$hargasatuanaset=$keterangan=$kategori=$brand="";
    $no = $_GET["no"];
    $insert = '1';
...
<div class="row">
    <div class="form-group col-md-6 col-xs-12">
        ...
        <div class="col-sm-9">
            <?php if($no == null || $no == ""): ?>
                <input type="text" class="form-control" id="sku" name="sku" value="IT-" oninput="formatSKU(this)" maxlength="50" required>
            <?php else: ?>
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
          ...
          if($chmod >= 3 || $_SESSION['jabatan'] == 'admin'){
                  $sql1 = "update $tabeldatabase set sku='$sku', nama='$nama', hargasatuanaset='$hargasatuanaset', kategori='$kategori', sisa='$sisa', minstok='$min', brand='$brand', keterangan='$keterangan' where kode='$kode'";
