...
$trun10 = mysqli_query($conn, 'TRUNCATE TABLE customer ');
...
?>
        ...
        <div class="form-group">
         <label for="checkbox" class="col-sm-2 control-label">Responsive</label>
           ...
           <div class="form-group">
         <label for="checkbox" class="col-sm-2 control-label">Aktifkan Demo</label>
                  <div class="col-sm-10">
...
if(isset($_POST['simpan'])){
  ...
  if(!isset($_POST["checkbox"])){
    $checkbox = '1';
           ...
           $sql1 = "update backset set url='$url', sessiontime='$session', footer='$footer', responsive='$checkbox', demo='$demo'";
